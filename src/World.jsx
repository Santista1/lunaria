...
function Lights() {
  ...
  return (
    <>
      <pointLight distance={12} color='deeppink' position={[0, 0, 45]} intensity={switch0 ? 0.4 : 0} />
      ...
      <pointLight distance={12} color='deeppink' position={[0, 0, 0]} intensity={on3 ? 0.4 : 0} />
      ...
      <pointLight distance={12} color='deeppink' position={[0, 0, -45]} intensity={on6 ? 0.4 : 0} />
      <Instances>
