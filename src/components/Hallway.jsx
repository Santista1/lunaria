...
function Lights() {
  ...
  return (
    <>
      <pointLight castShadow distance={12} color='blue' position={[0, 0, 0]} intensity={switch0 ? 0.4 : 0} />
      <pointLight castShadow distance={12} color='hotpink' position={[0, 0, -15]} intensity={on1 ? 0.4 : 0} />
      <pointLight castShadow distance={12} color='blue' position={[0, 0, -30]} intensity={on2 ? 0.4 : 0} />
      <pointLight castShadow distance={12} color='hotpink' position={[0, 0, -45]} intensity={on3 ? 0.4 : 0} />
      <pointLight castShadow distance={12} color='blue' position={[0, 0, -60]} intensity={on4 ? 0.4 : 0} />
      <pointLight castShadow distance={12} color='hotpink' position={[0, 0, -75]} intensity={on5 ? 0.4 : 0} />
      <pointLight castShadow distance={12} color='blue' position={[0, 0, -90]} intensity={on6 ? 0.4 : 0} />
      <Instances>
        <boxGeometry args={[1, 1, 1]} />
        <meshBasicMaterial />
        <Instance onClick={() => setSwitch0(!switch0)} color='red' position={[2.9, 0, 4.3]} scale={buttonScale} />
        <Instance
          ...
          scale={coverScale}
        />
        <Instance onClick={() => setOn1(!on1)} color='red' position={[2.9, 0, 4.3 - 15]} scale={buttonScale} />
        <Instance
          onClick={() => setOn1(!on1)}
          ...
          scale={coverScale}
        />
        <Instance onClick={() => setOn2(!on2)} color='red' position={[2.9, 0, 4.3 - 30]} scale={buttonScale} />
        <Instance
          onClick={() => setOn2(!on2)}
          ...
          scale={coverScale}
        />
        <Instance onClick={() => setOn3(!on3)} color='red' position={[2.9, 0, 4.3 - 45]} scale={buttonScale} />
        <Instance
          onClick={() => setOn3(!on3)}
          ...
          scale={coverScale}
        />
        <Instance onClick={() => setOn4(!on4)} color='red' position={[2.9, 0, 4.3 - 60]} scale={buttonScale} />
        <Instance
          onClick={() => setOn4(!on4)}
          ...
          scale={coverScale}
        />
        <Instance onClick={() => setOn5(!on5)} color='red' position={[2.9, 0, 4.3 - 75]} scale={buttonScale} />
        <Instance
          onClick={() => setOn5(!on5)}
          ...
          scale={coverScale}
        />
        <Instance onClick={() => setOn6(!on6)} color='red' position={[2.9, 0, 4.3 - 90]} scale={buttonScale} />
        <Instance
          onClick={() => setOn6(!on6)}
