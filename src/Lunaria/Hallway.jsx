  ...
  return (
    <>
      {/* <Html
        ...
        pointerEvents='none'
      >
        <p style={{ fontFamily: "Jura", color: "white", fontSize: 10 }}>{p.text}</p>
      </Html> */}
      ...
      <Image pos={[-0.05, 0, 7]} rotation={[0, 270 * (Math.PI / 180), 0]} src={p.urls[4]} bgcolor='black' />
      <Image pos={[-0.05, 0, 5]} rotation={[0, 270 * (Math.PI / 180), 0]} src={p.urls[5]} />
      <Image pos={[-0.05, 0, -5]} rotation={[0, 270 * (Math.PI / 180), 0]} src={p.urls[6]} />
      <Image pos={[-0.05, 0, -7]} rotation={[0, 270 * (Math.PI / 180), 0]} src={p.urls[7]} />
    </>
  )
}
