  ...
  return (
    <>
      <Instances>
        ...
        <Walls position={[15, 0, -10]} />
        <Walls position={[15, 0, 0]} />
        <Walls position={[15, 0, 10]} />
        <Instance position={[15, 1.5, 4.5 - 10]} scale={[0.2, 6, 0.2]} />
        <Instance position={[15, 1.5, -4.5 - 10]} scale={[0.2, 6, 0.2]} />
        <Instance position={[15, 1.5, 4.5]} scale={[0.2, 6, 0.2]} />
        <Instance position={[15, 1.5, -4.5]} scale={[0.2, 6, 0.2]} />
        <Instance position={[15, 1.5, 4.5 + 10]} scale={[0.2, 6, 0.2]} />
        <Instance position={[15, 1.5, -4.5 + 10]} scale={[0.2, 6, 0.2]} />
      </Instances>
    ...
    <>
      <group position={[14.99, 0, 10]}>
        ...
        <Image
          pos={[0, 0, -1]}
          rotation={[0, 270 * (Math.PI / 180), 0]}
          src='https://res.cloudinary.com/dexin8o58/image/upload/v1687563135/Nfts/1673579936098174_p46kde.avif'
        />
        <Image
          pos={[0, 0, 1]}
          rotation={[0, 270 * (Math.PI / 180), 0]}
          src='https://res.cloudinary.com/dexin8o58/image/upload/v1687563137/Nfts/Zaradar_Quantum_Mint_Mania_t5iub8.avif'
        />
        <Image
          pos={[0, 0, 3]}
          rotation={[0, 270 * (Math.PI / 180), 0]}
          src='https://res.cloudinary.com/dexin8o58/image/upload/v1687563130/Nfts/Zaradar_KungFu_Panda_cs2nod.avif'
        />
        <Image
          pos={[0, 3, -3]}
          rotation={[0, 270 * (Math.PI / 180), 0]}
          src='https://res.cloudinary.com/dexin8o58/image/upload/v1687563141/Nfts/Dear_Leader_Chairman_Ed_Kim_bgnqyn.avif'
        />
        <Image
          pos={[0, 3, -1]}
          rotation={[0, 270 * (Math.PI / 180), 0]}
          src='https://res.cloudinary.com/dexin8o58/image/upload/v1687563127/Nfts/Toby__Ed_raping_LUNC_ccoqoj.avif'
        />
        <Image
          pos={[0, 3, 1]}
          rotation={[0, 270 * (Math.PI / 180), 0]}
          src='https://res.cloudinary.com/dexin8o58/image/upload/v1687563109/Nfts/53c1fd6215e37ebc8c6aebd00d3e89e03254c0dc_kudkj4.avif'
        />
        <Image
          pos={[0, 3, 3]}
          rotation={[0, 270 * (Math.PI / 180), 0]}
          src='https://res.cloudinary.com/dexin8o58/image/upload/v1687563111/Nfts/7b1e48ee9de00a1cb12f09d8093e6637486165fd_hjputw.avif'
        />
      </group>
    </>
  )
